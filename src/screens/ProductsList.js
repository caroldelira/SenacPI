...
export function ProductsList({ navigation, route }) {
  ...
  const [productsData, setProductsData] = useState([
      { id: '1', name: 'Arroz de alguma marca outra marca', price: '4.00', quantity: 3, amount: '12,00' },
      { id: '2', name: 'Arroz de alguma marca', price: '4.00', quantity: 3, amount: '12,00' },
      { id: '3', name: 'Arroz de alguma marca', price: '4.00', quantity: 3, amount: '12,00' },
  ]);

  const { name } = route.params;

  const handleAddProduct = () => {
    const totalAmount = (parseFloat(newProduct.price) * parseInt(newProduct.quantity)).toFixed(2);

    setProductsData([...productsData, { ...newProduct, amount: totalAmount, id: Date.now().toString() }]);
            ...
            <View style={styles.modalView}>
              ...
              <View style={styles.actionView}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => setNewProduct({ ...newProduct, quantity: text.replace(/[^0-9.]/g, '') })}
                  keyboardType="numeric"
                />
